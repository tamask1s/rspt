...
public:
    signal_packer_xdelta_hzr(size_t bytes_per_channel, size_t nr_of_channels, size_t nr_of_samples_in_each_channel)
...
i_signal_packer* i_signal_packer::new_xdelta_hzr(size_t bytes_per_channel, size_t nr_of_channels, size_t nr_of_samples_in_each_channel)
{
    return new signal_packer_xdelta_hzr(bytes_per_channel, nr_of_channels, nr_of_samples_in_each_channel);
}
